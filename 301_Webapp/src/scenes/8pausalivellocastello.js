export default class pausalivellocastello extends Phaser.Scene {


    constructor(){
		super("pausalivellocastello");
    }
    ...
    preload(){
        console.log("pausalivellocastello - Executing preload()");
    }


    create(){
        console.log("pausalivellocastello - Executing create()");
